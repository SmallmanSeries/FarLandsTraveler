...
public class DataRegister{
    ...
    public static final ResourceKey<Registry<BiomeSource>> BIOME_SOURCE = ResourceKey.createRegistryKey(ResourceLocation.fromNamespaceAndPath("farlandstraveler","worldgen/biome_source"));
    // 更多注册敬请期待~~~
